...
class PositionListManager(models.Manager):
    ...
    @staticmethod
    def remove_positions_ignored_by_voter(positions_list, organizations_ignored_by_voter):
        """
        We need a list of positions that were NOT made by an organization, public figure or friend
        that this voter follows
    ...
    @staticmethod
    def fetch_positions_count_for_candidate(
            candidate_id,
            candidate_we_vote_id,
            stance_we_are_looking_for,
    ...
    @staticmethod
    def fetch_positions_count_for_contest_office(
            contest_office_id,
            contest_office_we_vote_id,
            stance_we_are_looking_for,
            public_or_private=PUBLIC_ONLY):
    ...
    @staticmethod
    def fetch_positions_count_for_contest_measure(
            contest_measure_id,
            contest_measure_we_vote_id,
            stance_we_are_looking_for,
            public_or_private=PUBLIC_ONLY):
...
class PositionManager(models.Manager):
    ...
    @staticmethod
    def retrieve_organization_candidate_position(
            organization_id,
            candidate_id,
    ...
    @staticmethod
    def toggle_on_voter_support_for_candidate(
            voter_id,
            candidate_id,
            user_agent_string,
            user_agent_object):
    ...
    @staticmethod
    def toggle_off_voter_support_for_contest_measure(voter_id, contest_measure_id, user_agent_string, user_agent_object):
        stance = NO_STANCE
        position_manager = PositionManager()
        return position_manager.toggle_on_voter_position_for_contest_measure(
            voter_id, contest_measure_id, stance, user_agent_string, user_agent_object)
    ...
    @staticmethod
    def reset_position_image_details(
            position_object,
            ballot_item_image_url_https=None,
...
class PositionMetricsManager(models.Manager):
    ...
    @staticmethod
    def fetch_positions_public_with_comments(google_civic_election_id=0, positions_taken_by_these_voter_we_vote_ids=False):
        candidate_we_vote_id_list = []
        if positive_value_exists(google_civic_election_id):
            candidate_list_manager = CandidateListManager()
            google_civic_election_id_list = [google_civic_election_id]
    ...
    @staticmethod
    def fetch_positions_friends_only_with_comments(google_civic_election_id=0, positions_taken_by_these_voter_we_vote_ids=False):
        candidate_we_vote_id_list = []
        if positive_value_exists(google_civic_election_id):
            candidate_list_manager = CandidateListManager()
            google_civic_election_id_list = [google_civic_election_id]
